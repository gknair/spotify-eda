...
The catchphrase **Data is the new currency** is becoming quite prevalent in our day to day conversations and news feed. As per the [statista reoprt]([https://www.statista.com/statistics/871513/worldwide-data-created/) released in May 2020, 2021 is expected to consume 74 zettabytes (1 zettabyte = trillion gigabytes) of data worldwide. This number is projected to almost double in just 3 years by 2024.
...
The most fascinating thing about having data accessible on any subject ranging from the most absurd ones (squirrel census in Central Park) to the most arcane ones (dermatoscopic images) and sometimes to the most personal ones (Whatsapp chats/location history) is, that you can develop familiarity with an unfamiliar subject in the most organic way by analyzing them. Sometimes, you also stumble upon incredible insights despite having decent understanding of the subject. 

With that said, you need to be careful about understanding the definition of data fields, the quality of the data and how you analyze/summarise it to not derive incorrect conclusions. It is equally important to have a fair idea on the questions you hope to answer through your data analysis once you know the attributes of data. Otherwise, you can get exhausted by the ways you can slice, summarise, and visualize the data and can possibly drown yourself in the vastness of it.  

Many organizations perform exploratory data analyses for two main purposes. 

1. to enable stakeholders take data driven decisions 
2. to understand the interplays of various data fields that helps develop and validate better prediction models

My purpose for today's exploratory data analysis is to understand
...
Can we conclude from these two tracks that having high energy, danceability, and explicit content is the key to higher popularity? Probably we analyze further. 
